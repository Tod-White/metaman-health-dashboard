...
function loadData() {
    const defaultData = {
        ...
        '2026-06-11': {
            ...
            notes: '还是坚信一定可以治好颈椎！\n\n昨天体感没有下降太多，但是外面下雨，只活动了一次，在家里的坐地活动效果感觉不如最开始好，晚上垫毛巾依然有效。另外昨天单次坐着的时间相对较长，这个需要特别注意。\n\nAI建议：\n1. 雨天室内活动替代方案需要升级——坐地活动效果下降可能是因为身体已经适应，建议增加靠墙深蹲或站姿拉伸变体\n2. 单次久坐是危险信号——建议每30分钟设置提醒站起来活动2分钟，哪怕只是原地踏步或颈部转动\n3. 体感维持在6分说明垫毛巾的被动支撑仍然有效，但要注意主动训练不能因为天气而中断\n4. 对比Day67的5分，今天回到6分是好趋势——说明睡眠支撑确实在起作用，继续保持',
            title: '雨天与久坐',
            observation: 'AI治颈椎Day68｜雨天与久坐'
        }
    };
